...
| ai-language-tells | `Context/Systems/ai-language-tells.md` | AI-language tells catalog, plain-word alternatives, and the pre-send self-check (supports the "No AI Tells" rule in `main.md`) |
...
3. Add the system to the navigation sequence in `main.md` if it applies to all tasks.
