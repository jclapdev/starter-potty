...
| mcp-builder         | `Context/Skills/mcp-builder/SKILL.md`         | Guide for creating high-quality MCP servers in Python (FastMCP) or Node/TypeScript; covers tool design, API coverage, and error handling |
| skill-creator       | `Context/Skills/skill-creator/SKILL.md`       | Create new skills from scratch, edit or optimize existing skills, run evals, and benchmark skill performance          |
